...
if manifest.get("phase") != 12:
    errors.append("phase must be 12")

if manifest.get("status") != "ready_for_0_1_0_release_candidate_audit":
    errors.append("status must be ready_for_0_1_0_release_candidate_audit")
